        ...
        <div className='bg-neutral-800 MainContainer'>
            <div className='container mx-auto'>
                <div className='box grid grid-cols-12 gap-x-0'>
                    {/* box1---------------------------------- */}
                    <div className='col-start-1 col-end-5 border-4 border-[#b98d58] text-center m-16 p-12'>
                        <img className='w-11/12' src={image} alt="" />
                        <p className='text-white text-3xl'>18kt White Gold Wedding Ring For $2,000</p>
                        <button className="btn btn-active rounded-none border-none bg-[#b98d58] px-24 py-4 mt-8">Buy now</button>
                    </div>
